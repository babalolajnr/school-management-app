                                ...
                                <table id="notifications-table" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach (auth()->user()->notifications as $notification)
                                            <tr
                                                class="@if ($notification->read())
                                                text-muted
                                            @endif">
                                                <td>
                                                    @if (strlen($notification->data['title']) > 30)
                                                        {{ substr($notification->data['title'], 0, 30) }}...
                                                    @else
    ...
    <x-slot name="scripts">
        ...
        <script>
            $(function() {
                ...
                }).buttons().container().appendTo('#notifications-table_wrapper .col-md-6:eq(0)');
            });
        </script>
    </x-slot>
</x-app-layout>
